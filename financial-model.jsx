...
const STARTUPS = [
  { id: 0, name: "AI Chief of Staff", emoji: "🧠", color: "#C9A84C", short: "CoS" },
  { id: 1, name: "AI Governance aaS", emoji: "⚖️", color: "#4C8EC9", short: "Gov" },
  { id: 2, name: "Decision Support", emoji: "📊", color: "#9B6CD9", short: "DSS" },
  { id: 3, name: "Combined Suite", emoji: "🏢", color: "#4CC9A8", short: "All" },
];
